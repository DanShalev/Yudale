...
/*SAME CODE IN jqm_dfooter (debts footer), GET variables from there.
 */

if (!isset($sum_search)) { //ONLY EXECUTE IF $sum_search IS NOT SET
if(!isset($con))
...
<div data-role="panel" id="main_panel" data-position-fixed="true" data-display="push">
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="a">
        ...
        <li><a href="<?php echo $base_href ?>log-file.php" data-ajax="false"  class="ui-btn ui-icon-search ui-btn-icon-left">
                Log File</a></li>

        <li data-role="list-divider">Account</li>

        <li><a href="<?php echo $base_href ?>account_settings.php" data-ajax="false"  class="ui-btn ui-icon-gear ui-btn-icon-left">
                Account Settings</a></li>
        <li><a href="<?php echo $base_href ?>php_process/logout.php" data-ajax="false"  class="ui-btn ui-icon-back ui-btn-icon-left">
                Log Out</a></li>

        <li data-role="list-divider">About</li>

        <li><a href="<?php echo $base_href ?>about.php" data-ajax="false"  class="ui-btn ui-icon-info ui-btn-icon-left">
                About</a></li>
    </ul>
</div>